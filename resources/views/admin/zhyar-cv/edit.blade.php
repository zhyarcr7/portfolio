                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input type="text" name="title" id="title" value="{{ old('title', $zhyarCv->title) }}" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" required>
                                    @error('title')
                                ...
                                <div>
                                    ...
                                    <textarea name="content" id="content" rows="4" class="mt-1 block w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md shadow-sm" required>{{ old('content', $zhyarCv->content) }}</textarea>
                                    @error('content')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    <label class="relative flex hover:bg-gray-50 cursor-pointer rounded-md p-4 border-2 border-dashed border-gray-300">
                                        <input type="file" name="file_path" id="file_path" class="absolute inset-0 opacity-0 w-full h-full cursor-pointer" accept=".pdf,.doc,.docx">
                                        <div class="w-full text-center">
                                            ...
                                            <span class="mt-1 block text-sm text-gray-500" id="cv_file_name">
                                                @if ($zhyarCv->file_path)
                                                    Current file: {{ $zhyarCv->file_path }}
                                                @else
                                                    PDF (max 10MB)
                                                @endif
                                            </span>
                                    ...
                                    <input type="hidden" name="file_path" id="direct_file_path">
                                </div>
            ...
            .then(data => {
                ...
                if (data.success) {
                    ...
                    notification.innerHTML = `
                        ...
                        <p class="mt-1">The file path has been added to the form. Save changes to update the CV record.</p>
                    `;
